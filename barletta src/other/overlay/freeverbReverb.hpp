...
private:
    ...
    void updateWetValues(); // (updated for panning depth)
...
public:
    ...
    void mute();
    void setPanningDepth(float depth); // Set the stereo panning exaggeration multiplier
    void setInHeadMode(bool enabled);  // Enable/disable in-head left/right mode
    void setInHeadDirection(int dir);  // -1=left, 0=center, 1=right
};
